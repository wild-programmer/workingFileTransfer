...
// import { Certification, Member } from "../components";
...
export default class IpArt extends React.Component<IpArtProps, IpArtState> {
  ...
  _changeTab(item: any) {
    if (item.id === 1) {
      ...
      return (
        <i className="iconfont icon-estimate estimate"/>
      );
    } else {
      return (
        <i className="iconfont icon-calculate calculate"/>
      );
    }
  }
